...
HOST_SRC_CPP =  ./src/host/test_deepnn.cpp ./src/host/layer.cpp ./src/host/utils.cpp
...
OCL_KERNEL_H = ./src/host/typedef.h ./src/host/layer.h

SDSOC_KERNEL_SRC = ./src/kernel/bnn.cpp
SDSOC_KERNEL_H = ./src/host/typedef.h ./src/host/layer.h

SW_KERNEL_SRC = ./src/kernel/bnn.cpp
SW_KERNEL_H = ./src/host/typedef.h ./src/host/layer.h ./src/host/bnn.h
